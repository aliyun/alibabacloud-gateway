...
"""
setup module for alibabacloud_gateway_fc.
...
PACKAGE = "alibabacloud_gateway_fc"
NAME = "alibabacloud_gateway_fc" or "alibabacloud-package"
DESCRIPTION = "Alibaba Cloud FC SDK Library for Python"
AUTHOR = "Alibaba Cloud SDK"
...
REQUIRES = [
    ...
    "alibabacloud_darabonba_signature_util>=0.0.2, <1.0.0",
...
setup(
    ...
    url=URL,
    keywords=["alibabacloud","gateway","fc"],
