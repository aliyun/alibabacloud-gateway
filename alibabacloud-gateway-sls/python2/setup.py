...
PACKAGE = "alibabacloud_gateway_sls"
NAME = "alibabacloud_gateway_sls_py2" or "alibabacloud-package"
DESCRIPTION = "Alibaba Cloud SLS Gateway Library for Python2"
AUTHOR = "Alibaba Cloud SDK"
...
REQUIRES = [
    ...
    "alibabacloud_gateway_sls_util_py2>=0.0.1, <1.0.0"
]
...
setup(
    ...
    url=URL,
    keywords=["alibabacloud","gateway","sls","py2"],
