...
public class PostLogStoreLogsResponse extends TeaModel {
    ...
    public static PostLogStoreLogsResponse build(java.util.Map<String, ?> map) throws Exception {
        PostLogStoreLogsResponse self = new PostLogStoreLogsResponse();
        return TeaModel.build(map, self);
    }

    public PostLogStoreLogsResponse setHeaders(java.util.Map<String, String> headers) {
    ...
    public static class PullLogsResponseBody implements Serializable {
        ...
        public PullLogsResponseBody(byte[] rawData, int statusCode, Map<String, String> headers) {
