...
"""
setup module for alicloud-gateway-iot-py2.
...
PACKAGE = "alicloud_gateway_iot"
NAME = "alicloud-gateway-iot-py2" or "alibabacloud-package"
DESCRIPTION = "Alibaba Cloud IOT SDK Library for Python2"
AUTHOR = "Alibaba Cloud SDK"
...
setup(
    ...
    url=URL,
    keywords=["alicloud","gateway","iot","py2"],
