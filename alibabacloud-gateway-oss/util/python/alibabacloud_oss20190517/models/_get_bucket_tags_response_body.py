...
class GetBucketTagsResponseBody(DaraModel):
    def __init__(
        self,
        tagging: main_models.GetBucketTagsResponseBodyTagging = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tagging') is not None:
            temp_model = main_models.GetBucketTagsResponseBodyTagging()
            self.tagging = temp_model.from_map(m.get('Tagging'))

        return self

class GetBucketTagsResponseBodyTagging(DaraModel):
    def __init__(
        self,
