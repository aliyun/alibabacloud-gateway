...
class DeleteCnameRequest(DaraModel):
    def __init__(
        self,
        bucket_cname_configuration: main_models.DeleteCnameRequestBucketCnameConfiguration = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BucketCnameConfiguration') is not None:
            temp_model = main_models.DeleteCnameRequestBucketCnameConfiguration()
            self.bucket_cname_configuration = temp_model.from_map(m.get('BucketCnameConfiguration'))

        return self

class DeleteCnameRequestBucketCnameConfiguration(DaraModel):
    def __init__(
        self,
        cname: main_models.DeleteCnameRequestBucketCnameConfigurationCname = None,
    ):
        self.cname = cname
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cname') is not None:
            temp_model = main_models.DeleteCnameRequestBucketCnameConfigurationCname()
            self.cname = temp_model.from_map(m.get('Cname'))

        return self

class DeleteCnameRequestBucketCnameConfigurationCname(DaraModel):
    def __init__(
        self,
        domain: str = None,
    ):
