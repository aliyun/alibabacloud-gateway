...
class PutVirtualBucketRequest(DaraModel):
    def __init__(
        self,
        virtual_bucket_configuration: main_models.VirtualBucketConfiguration = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VirtualBucketConfiguration') is not None:
            temp_model = main_models.VirtualBucketConfiguration()
