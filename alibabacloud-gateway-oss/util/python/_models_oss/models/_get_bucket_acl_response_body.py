...
class GetBucketAclResponseBody(DaraModel):
    def __init__(
        self,
        access_control_policy: main_models.GetBucketAclResponseBodyAccessControlPolicy = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessControlPolicy') is not None:
            temp_model = main_models.GetBucketAclResponseBodyAccessControlPolicy()
            self.access_control_policy = temp_model.from_map(m.get('AccessControlPolicy'))

        return self

class GetBucketAclResponseBodyAccessControlPolicy(DaraModel):
    def __init__(
        self,
        access_control_list: main_models.GetBucketAclResponseBodyAccessControlPolicyAccessControlList = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessControlList') is not None:
            temp_model = main_models.GetBucketAclResponseBodyAccessControlPolicyAccessControlList()
...
class GetBucketAclResponseBodyAccessControlPolicyAccessControlList(DaraModel):
    def __init__(
        self,
        grant: str = None,
    ):
