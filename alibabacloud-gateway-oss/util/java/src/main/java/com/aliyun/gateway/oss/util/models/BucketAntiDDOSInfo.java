...
public class BucketAntiDDOSInfo extends TeaModel {
    ...
    @NameInMap("Cnames")
    public BucketAntiDDOSInfoCnames cnames;
    ...
    public BucketAntiDDOSInfo setCnames(BucketAntiDDOSInfoCnames cnames) {
        this.cnames = cnames;
        return this;
    }
    public BucketAntiDDOSInfoCnames getCnames() {
        return this.cnames;
    }
    ...
    public static class BucketAntiDDOSInfoCnames extends TeaModel {
        @NameInMap("Domain")
        public java.util.List<String> domain;

        public static BucketAntiDDOSInfoCnames build(java.util.Map<String, ?> map) throws Exception {
            BucketAntiDDOSInfoCnames self = new BucketAntiDDOSInfoCnames();
            return TeaModel.build(map, self);
        }

        public BucketAntiDDOSInfoCnames setDomain(java.util.List<String> domain) {
            this.domain = domain;
            return this;
        }
