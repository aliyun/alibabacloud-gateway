...
public class GetBucketPublicAccessBlockResponse extends TeaModel {
    ...
    @NameInMap("body")
    public GetBucketPublicAccessBlockResponseBody body;
    ...
    public GetBucketPublicAccessBlockResponse setBody(GetBucketPublicAccessBlockResponseBody body) {
        this.body = body;
        return this;
    }
    public GetBucketPublicAccessBlockResponseBody getBody() {
        return this.body;
    }
