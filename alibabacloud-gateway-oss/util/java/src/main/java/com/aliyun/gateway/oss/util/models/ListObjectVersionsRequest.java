...
public class ListObjectVersionsRequest extends TeaModel {
    ...
    /**
     * <p>The maximum number of objects to be returned. If the number of returned objects exceeds the value of max-keys, the response contains <code>NextKeyMarker</code> and <code>NextVersionIdMarker</code>. Specify the values of <code>NextKeyMarker</code> and <code>NextVersionIdMarker</code> as the markers for the next request. Valid values: 1 to 999. Default value: 100.</p>
     * 
     * <strong>example:</strong>
     * <p>100</p>
     */
     ...
     * <ul>
     * <li>The value of prefix must be less than 1,024 bytes in length.</li>
